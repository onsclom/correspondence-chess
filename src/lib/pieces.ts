...
const piecesSVG: Record<PieceType, { white: string; black: string }> = {
  k: {
    white: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
    ...
    black: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
      <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
export function getPieceSVG(type: PieceType, color: Color): string {
  return piecesSVG[type][color === 'w' ? 'white' : 'black'];
}
